...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Total%20Contributed%20Stars-30,220-00ff7f?style=for-the-badge&logo=github&logoColor=black" alt="Total Stars" />
</p>
...
| :--- | :---: | :---: | :--- |
| **[lirantal/nodejs-cli-apps-best-practices](https://github.com/lirantal/nodejs-cli-apps-best-practices)** | ⭐ 4,002 | [#133](https://github.com/lirantal/nodejs-cli-apps-best-practices/pull/133 "test: add argument injection evaluation 🤖🤖🤖") | The largest Node.js CLI Apps best practices list ✨ |
...
| **[silexlabs/Silex](https://github.com/silexlabs/Silex)** | ⭐ 2,846 | [#1733](https://github.com/silexlabs/Silex/pull/1733 "fix: exit with error code if package build fails") | Silex is an online tool for visually creating static sites with dynamic data. With the free/libre spirit of internet, together. |
| **[NASA-AMMOS/3DTilesRendererJS](https://github.com/NASA-AMMOS/3DTilesRendererJS)** | ⭐ 2,347 | [#1645](https://github.com/NASA-AMMOS/3DTilesRendererJS/pull/1645 "fix: vitest: include .tsx files in test execution") | Renderer for 3D Tiles in Javascript using three.js, Babylon.js, and r3f |
...
| **[kanoqwq/UFI-TOOLS](https://github.com/kanoqwq/UFI-TOOLS)** | ⭐ 1,523 | [#103](https://github.com/kanoqwq/UFI-TOOLS/pull/103 "fix: replace static salt with cryptographically secure random salt") | A functional tools for z*e devices (F50 \| U30 Air) |
| **[cweijan/vscode-office](https://github.com/cweijan/vscode-office)** | ⭐ 1,407 | [#464](https://github.com/cweijan/vscode-office/pull/464 "fix: standardize build script in package.json") | Let VSCode support previewing PDF, Excel, Word and other formats, and add markdown WYSIWYG editor. |
...
| **[develop202/migu_video](https://github.com/develop202/migu_video)** | ⭐ 1,196 | [#122](https://github.com/develop202/migu_video/pull/122 "fix: correct mergeTVCategory logic and enhance network reliability") | No description provided. |
...
| **[DowneyRem/PixivSource](https://github.com/DowneyRem/PixivSource)** | ⭐ 895 | [#80](https://github.com/DowneyRem/PixivSource/pull/80 "fix: add file existence checks to RSS builder scripts") | 最好的 Pixiv 第三方小说阅读器——开源阅读 + Pixiv 书源 / Legado with Pixiv BookSource, the Best Third-Party Novel Reader for Pixiv |
...
| **[Darkatse/TauriTavern](https://github.com/Darkatse/TauriTavern)** | ⭐ 713 | [#95](https://github.com/Darkatse/TauriTavern/pull/95 "fix: add input validation for tauri bridge interface") | The classic Sillytavern, now has been rewritten in Tauri/Rust. |
